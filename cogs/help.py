...
class Help(commands.Cog):
    ...
    async def help(self, interaction: discord.Interaction):
        ...
        channel_settings = """
            ...
            """
        embed.add_field(name="🔧 채널 설정", value=channel_settings, inline=False)

        # 📝 주의사항
        notes = """
        
            • 모든 명령어는 **설정된 채널**에서만 사용할 수 있습니다  
            • 음악을 재생하려면 먼저 **음성 채널에 접속**해야 합니다  
            • `/보상금` 및 `/벌금` 명령어는 **개발자만** 사용할 수 있습니다  
            • `/이자`는 하루에 한 번만 받을 수 있으며, 최소 10,000 LC 이상의 잔고가 필요합니다  
